...
<body>
    ...
    <div class="container">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          ...
          if (@$level == "1") {
          ?>
            <li><a href="?p=list_barang&halaman">Daftar Inventaris</a></li>
            <li><a href="?p=pegawai&halaman">Pegawai</a></li>
  ...
  <!-- footer -->
  <footer>
    <center>Copyright &copy; By MUH TORIQUL H.P.F XII RPL STERIDA 2023 NO.ABSEN 26</center>
  </footer>
